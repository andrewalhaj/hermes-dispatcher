...
const CANNED: Record<string, string> = {
  ...
  'rvc-runner': 'Queued on the GPU; I’ll report latency when the run completes.',
  'atlas-etl': 'Kicked off the ETL pass — watching for row errors.',
  'npc-builder': 'Drafting that content now.',
  'ops-bot': 'Acknowledged — running the infra check.',
}
...
export const PROFILE_OPTIONS = ['default', 'reviewer', 'ops-bot']
    ...
    },
    {
      ...
      detail: {
        ...
        lines: [
          ...
          { text: '→ reserve GPU on rvc-runner', color: '#9298ab', indent: 14 },
    ...
    },
    {
      ...
      detail: {
        ...
        lines: [
          ...
          {
            text: 'No idle workers for 3 ready tasks; rvc-runner hit GPU OOM on model 3. Re-queuing behind the latency-gate run.',
...
export const INITIAL_THREADS: Record<string, Message[]> = {
  ...
  'atlas-etl': [{ id: 'a1', role: 'agent', text: 'Nightly S3 export running · 1.2M rows queued.', at: '1:20 PM' }],
  'npc-builder': [],
  'ops-bot': [],
}
