...
### E2 — README host description: MM01 → Linux x86_64
**Surprise removed:** README said "self-hosted on MM01" but the host is Linux x86_64
(kernel `7.0.12-1-t2-noble`), paths are the service user’s home, deployment is systemd. A reader following
